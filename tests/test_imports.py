...
def test_all_prior_files_exist():
    ...
    models = [
        ...
        'exponential_exponential', 'exponential_bpl', 'bpl_bpl', 'bpl_exponential',
        'boxwind_exponential', 'boxwind_bpl', 'gausswind_exponential', 'gausswind_bpl',
        ...
        'generic_4shell_csm_bpl', 'generic_8shell_csm_bpl',
    ]
...
def test_models_registered_in_redback():
    ...
    try:
        ...
        expected = [
            'wind_bpl_bolometric', 'wind_bpl',
            'wind_bpl_nickel_bolometric', 'wind_bpl_nickel',
            'gausswind_bpl_bolometric', 'gausswind_bpl',
...
def test_bolometric_model_callable():
    ...
    try:
        ...
        result = wind_bpl_bolometric(
            time=time,
            mdot=1e-3, vwind=100.0, delta=0.5, nn=12.0,
            mexp=10.0, eexp=1.0, eff=0.5, kappa=0.34,
        )
